...
#define STRING_CONFIG_H_AUTHOR "(MMcLure, Excruder III)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Excruder III"
//#define CONFIGURABLE_MACHINE_NAME // Add G-code M550 to set/report the machine name

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "b8138606-26bb-48a8-b179-4c1dd20a4aed"
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    // BTT 12V "50W" heater cartridge with Mellow "Semitec" thermistor
    // (measured after M106 255 with M303 C10 E0 S210)
    // #define DEFAULT_KP 19.0986
    // #define DEFAULT_KI 1.3998
    // #define DEFAULT_KD 65.1453
    // As above with plated copper block
    #define DEFAULT_KP 29.3719
    #define DEFAULT_KI 2.5122
    #define DEFAULT_KD 85.8504
  #endif
#else
 ...
 */
  ...
  #define MPC_BLOCK_HEAT_CAPACITY { 15.3380f }           // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 0.1995 }         // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 0.0836 }           // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  #if ENABLED(MPC_INCLUDE_FAN)
    #define MPC_AMBIENT_XFER_COEFF_FAN255 { 0.1158 }  // (W/K) Heat transfer coefficients from heat block to room air with fan on full.
  #endif
...
#define PIDTEMPBED
  ...
  // Gulfcoast Robotics uninsulated bed (M303 E-1 S65 C8)
  #define DEFAULT_BED_KP 46.30
  #define DEFAULT_BED_KI 9.07
  #define DEFAULT_BED_KD 157.57
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 6000, 4000, 100, 10000 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -29, 0, -1.82 }
...
#define LCD_BED_TRAMMING
   ...
   */
  #define BED_TRAMMING_LEVELING_ORDER { RF, RB }
#endif
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { -12, (Y_MIN_POS + 1), 20 }
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_START_POINT { { -14, 71, (Z_MIN_POS + 0.5) } }
  #define NOZZLE_CLEAN_END_POINT   { {  -6, 48, (Z_MIN_POS + 0.5) } }
...
#define NEOPIXEL_LED
  ...
  //#define NEOPIXEL_PIN     P0_01     // LED driving pin
